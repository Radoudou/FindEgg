        ...
        return (
            <Container className='container-EggStory'>
                <div className='eggStory-content'>
                    ...
                    <p>Cela fait déjà plusieurs jours qu’il s’est enfui de chez lui, loin de la douceur des plumes et de la chaleur familiale, désespérant de s’éloigner du conflit opposant les œufs et leurs cousins en chocolat, les seconds jalousant profondément la chance qu’ont les premiers de grandir et d’acquérir ces si douces plumes en devenant des pulls.</p>
                    <p>Malgré leurs efforts communs depuis des années, leur désir de merger se solde toujours par un échec, interrompant leur développement, et, ne trouvant pas de résolution le conflict explosa, éloignant, apparemment définitivement, les œufs jaunes et les œufs en chocolat.</p>
